...
const watching = () => {
    ...
    gulp.watch([srcFolder + '/svg-sprite/svg-icons/*.svg'], svgIcons);
...
exports.default = gulp.parallel(synchronization, watching, gulp.series(cleaning, markup, styles, scripts, images, svgIcons, svgSprite, fonts, files));